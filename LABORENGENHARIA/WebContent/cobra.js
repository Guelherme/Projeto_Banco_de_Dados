window.onload = function(){
			...
			function jogo(){
				...
				for (var i = 0; i< trilha.length; i++){
					contexto.fillRect(trilha[i].x * tamGride,trilha[i].y *tamGride,tamGride-1,tamGride-1);
				...
				contexto.fillRect( pontoX * tamGride, pontoY *tamGride, tamGride-1, tamGride-1);
			}
